...
Dada uma tabela com duas colunas A e B aonde A é uma letra do alfabeto [A..Z] randomincamente selecionada e B é um número entre [0,10] também randomicamente selecionado o objetivo é produzir uma nova tabela contendo três colunas: letra inicial (letra_i), letra final (letra_f) e peso, de modo que o peso corresponda a quantidade de vezes que o mesmo número ocorre simultaneamente entre _letra_i_ e _letra_f_.
...
>**Conclusão Parcial: **O algoritmo do João é mais eficiente até uma entrada de 100.000 valores

> **Observações:** Não estamos variando as possibilidades das letras, apenas as combinações de números, isso influencia diretamente no resultado. É provável que as performances mudem com maior variabilidade de combinações de letras e números bem como o armazenamento das estruturas. Deixaremos de ter um problema puramente _cpubound_ para termos um problema _iobound_ e _cpubound_ juntos.
